...
<body class="relative" data-modalToggled="false">
    ...
    <header class="flex flex-row m-auto justify-center pb-20">
        <div class="w-4/12">
            <img src="assets/images/image-3.jpg" class="rounded-md m-auto"/>
        </div>
        <div class="w-6/12">
            <div class="flex flex-row text-gray-400">
                <span class="mr-2 mb-4">RONALD RICHARDS</span>
                <span class="event-detail-date">25th DEC, 2020.</span>
            </div>
            <h1 class="event-detail-name">Bill Gates, Amazon and British Airways are backing a hydrogen plane startup</h1>
