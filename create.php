...
<body>
        ...
        <main clas="">
                <div class="p-6 rounded-md container m-auto bg-white shadow-sm w-7/12">
                        <h1 class="font-bold text-3xl">Create An Event</h1>
                        ...
                        <div>
                            <form class="mt-10" method="post" action="./views/create-event.php">
                                <div class="flex flex-col mb-6">
                                    ...
                                    <input name="name"  required value="" class="outline-none bg-gray-100 p-2 rounded-md focus:ring-2 focus:ring-gray-200" type="text" placeholder="Name">
                                </div>

                                <div class="flex flex-col mb-6">
                                    <label class="mb-2 font-bold typo-heading">Date</label>
                                    <input name="date"  required value="" class="outline-none bg-gray-100 p-2 rounded-md focus:ring-2 focus:ring-gray-200" type="date" placeholder="Date">
                                </div>   
                                
                                <div class="flex flex-col mb-6">
                                    <label class="mb-2 font-bold typo-heading">Time</label>
                                    <input name="time"  required value="" class="outline-none bg-gray-100 p-2 rounded-md focus:ring-2 focus:ring-gray-200" type="time" placeholder="Time">
                                </div>     
                                
                                <div class="flex flex-col mb-6">
                                    <label class="mb-2 font-bold typo-heading">Location</label>
                                    <input name="location" required  value="" class="outline-none bg-gray-100 p-2 rounded-md focus:ring-2 focus:ring-gray-200" type="text" placeholder="Location">
                                </div>   

                                <div class="flex flex-col mb-6">
                                    <label class="mb-2 font-bold typo-heading">Image url</label>
                                    <input name="image_url" required  value="" class="outline-none bg-gray-100 p-2 rounded-md focus:ring-2 focus:ring-gray-200" type="url" placeholder="Image url">
                                </div>                                   
                                
                                <div class="flex flex-col mb-6">
                                    <label class="mb-2 font-bold typo-heading">Description</label>
                                    <textarea name="description"  required value="a" class="outline-none bg-gray-100 p-2 rounded-md focus:ring-2 focus:ring-gray-200" type="text" placeholder="Description">
                                    </textarea>
                                </div>                                   
                                <button id="event-registration" type="submit" name="create-account" class="p-4 bg-black text-white rounded-md w-full mb-4">
                                    Register for Event
                                </button>    
